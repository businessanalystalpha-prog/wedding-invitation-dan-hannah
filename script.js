...
// I-set ang volume ng background music
if (audio) {
  audio.volume = 0.50; 
}
...
/* ==========================================
   LOCAL VIDEO & AUTO-PAUSE BACKGROUND MUSIC
   ========================================== */
function handleVideoError() {
  const videoEl = document.getElementById('save-the-date-video');
...
const localVideo = document.getElementById('save-the-date-video');

if (localVideo && audio) {
  // Kapag in-play ang video, i-pause ang bg music
  ...
  // Kapag in-pause ang video, i-resume ang bg music
...
const faqKnowledgeBase = [
    ...
    },
    {
        ...
        answer: "Ang RSVP ay nagmula sa parilarang Pranses na 'Répondez s'il vous plaît' na nangangahulugang 'Please reply' o 'Pakiusap na sumagot'. Ginagamit ito para kumpirmahin kung makakadalo ka sa kaganapan upang maipareserba ang inyong upuan."
    },
    {
...
// Register Event Listeners for FAQ Chat
